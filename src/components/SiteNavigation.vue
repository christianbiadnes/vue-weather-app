  ...
  <header class="sticky top-0 shadow-lg flex">
    <nav
      ...
      <div class="flex gap-3 flex-1 justify-end">
        <i
          class="fa-solid fa-circle-info text-2xl hover:text-weather-secondary cursor-pointer duration-150"
          @click="toggleModal"></i>
        <i
          class="fa-solid fa-plus text-2xl hover:text-weather-secondary cursor-pointer duration-150"
          @click="addCity"
